...
async function page({ params }: props) {
  ...
  const res: dbRes = dbitems! as dbRes;
  return (
    <>
      <StoreProvider>
        <div className="gameType-main flex">
          <div className="mt-7 mr-3 pr-4 w-3/4">
            {res.name === "rank-boost" ? (
              <>
                <DesiredRank gameN="Apex" data={res.Data.ranksData} />
            ...
            {res.name === "rank-wins" ? (
              <>
                <DesiredWins gameN="Apex" data={res.Data.ranksData} />
                <div className="gameTypeSpace"></div>
              </>
            ) : (
              ""
            )}
            {res.name === "unrank-wins" ? (
              <>
            ...
            <div className="gameType-cont">
              ...
              <div className="">
                <div className="">
                  <OptionToggle game="Apex" data={res.extraOptions} />
                </div>
                <div className="mt-4">
                  <div className="gameType-base eomain">
                    <OptionDropdown gameN="Apex" data={res.extraOptions2} />
                  </div>
                </div>
              </div>
            </div>
